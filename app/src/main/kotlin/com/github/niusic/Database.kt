...
import com.github.niusic.enums.ArtistSortBy
...
import com.github.niusic.models.Artist
import com.github.niusic.models.Event
import com.github.niusic.models.Format
import com.github.niusic.models.Info
import com.github.niusic.models.Lyrics
import com.github.niusic.models.Playlist
import com.github.niusic.models.PlaylistPreview
import com.github.niusic.models.PlaylistWithSongs
import com.github.niusic.models.QueuedMediaItem
import com.github.niusic.models.SearchQuery
import com.github.niusic.models.Song
import com.github.niusic.models.SongAlbumMap
import com.github.niusic.models.SongArtistMap
import com.github.niusic.models.SongPlaylistMap
import com.github.niusic.models.SongWithContentLength
import com.github.niusic.models.SortedSongPlaylistMap
...
interface Database {
    ...
    @Transaction
    @Query("SELECT Song.* FROM Event JOIN Song ON Song.id = songId GROUP BY songId ORDER BY timestamp DESC LIMIT 20")
    fun history(): Flow<List<Song>>
